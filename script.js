      ...
      item.innerHTML = `
                ...
                <div class="t-right">
                    ...
                    <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 4px;">
                        <div onclick="editTransaction(${transaction.id})" style="font-size: 12px; color: var(--primary-color); cursor: pointer; font-weight: 600;">
                            <i class="fa-solid fa-pen"></i> Edit
                        </div>
                        <div onclick="deleteTransaction(${transaction.id})" style="font-size: 12px; color: var(--danger-color); cursor: pointer; font-weight: 600;">
